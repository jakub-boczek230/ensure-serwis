...
const translations: Record<Language, Translation> = {
  pl: {
    ...
    form: {
      ...
      error: 'Wystąpił problem z formularzem. Zadzwoń pod 729 979 400 lub napisz na biuro.ensure@gmail.com.',
    },
    expert: {
  ...
  en: {
    ...
    form: {
      ...
      error: 'There was a problem with the form. Please call 729 979 400 or write to biuro.ensure@gmail.com.',
    },
    expert: {
    ...
    <div className="min-h-screen bg-[#f5f9fd] font-sans text-[#142129]">
      ...
      <main>
        <section id="start" className="relative flex min-h-screen items-center overflow-hidden bg-[#0c171f] pt-24 text-white">
          <div className="animate-image-drift absolute inset-0 bg-cover bg-center opacity-46" style={{ backgroundImage: "url('/images/ensure-hero-appraisal.jpg')" }} />
